  ...
  const projectData = [
    {
      ...
      category: 'Core',
      description: 'Developed a Raspberry Pi-based system for 2D contour detection and 3D depth mapping using OpenCV. Leverages computer vision techniques for spatial analysis. Keywords: Embedded, Linux, OpenCV, IoT.',
    },
    {
...

    {
      ...
      category: 'Core',
      description: 'Built an autonomous robot using Raspberry Pi for internal logistics, navigating warehouses with sensors and pathfinding algorithms. Keywords: Embedded, Linux, Robotics, IoT.',
...

    {
      ...
      category: 'Core',
      description: 'Developed an AI-integrated system using sensors for structural health monitoring, applying machine learning for failure prediction. Keywords: Embedded, IoT, AI, Robotics.',
    ...
    },
    {
      ...
      category: 'Core',
      description: 'Built a four-axis robot arm controlled by joysticks and mobile automation for precise tasks. Keywords: Embedded, Robotics, IoT.',
    },
    {
    ...
    },
    {
      ...
      category: 'Core',
      description: 'An autonomous delivery robot equipped with GPS and sensors for secure navigation and delivery. Keywords: Embedded, IoT, Robotics.',
    },
    {
    ...
    },
    {
      ...
      category: 'Core',
      description: 'Engineered a portable communication device for disasters with GPS and voice capabilities. Keywords: Embedded, IoT, Networking.',
    },
    {
...
<section className="py-12 bg-gradient-to-b from-gray-900 to-black px-8">
  <div className="max-w-4xl mx-auto text-center">
    <p className="text-lg text-gray-300 leading-relaxed font-poppins">
      Embedded Systems and IoT Engineer with strong hands-on experience in Linux-based embedded systems, microcontrollers (STM32, ESP32, Arduino), and Raspberry Pi. Skilled in Embedded C, Python, and system-level programming with practical exposure to computer vision using OpenCV, robotics, and industrial automation. Experienced in designing end-to-end IIoT solutions involving sensors, actuators, networking, and real-time monitoring dashboards. Passionate about building reliable, scalable, and intelligent embedded products.
    </p>
  </div>
</section>

{/* Core Competencies Section */}
<section className="py-12 bg-gradient-to-b from-black via-gray-900 to-black px-8">
  <motion.h2
    initial={{ opacity: 0, y: 50 }}
    whileInView={{ opacity: 1, y: 0 }}
    transition={{ duration: 0.8 }}
    className="text-3xl font-bold text-center mb-8 text-cyan-400 font-poppins"
  >
    Core Competencies
  </motion.h2>
  <div className="max-w-4xl mx-auto">
    <div className="flex flex-wrap justify-center gap-4">
      <span className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">Embedded Systems</span>
      <span className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">Embedded C</span>
      <span className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">Python</span>
      <span className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">Linux Embedded Systems</span>
      <span className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">STM32</span>
      <span className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">ESP32</span>
      <span className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">Raspberry Pi</span>
      <span className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">OpenCV</span>
      <span className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">Robotics</span>
      <span className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">Industrial IoT (IIoT)</span>
      <span className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">Computer Networking</span>
      <span className="px-4 py-2 bg-gray-800 text-gray-300 rounded-full text-sm">Automation Systems</span>
    </div>
  </div>
</section>
...
<section id="projects" className="py-20 bg-gradient-to-b from-black via-gray-900 to-black px-6">
  ...
  <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto">
    {projectData
      .filter((p) => ['AI-Based Structural Health Monitoring System', 'Internal Logistics Autonomous Robot', '2D Contour Detection & 3D Depth Mapping System', 'Autonomous GPS-Based Delivery Robot', 'Four-Axis Robotic Arm with Precision Control', 'Emergency Communication & Alert System'].includes(p.title))
      .map((project, index) => (
        <motion.div
          key={index}
  ...
  {/* Toggle for Additional Projects */}
  <div className="text-center mt-8">
    <button
      onClick={() => setShowAllProjects(!showAllProjects)}
      className="px-6 py-2 bg-cyan-400 text-black font-semibold rounded-full hover:bg-pink-500 hover:text-white transition duration-300"
    >
      {showAllProjects ? 'Hide' : 'View 15+ Additional Academic & Mini Projects'}
    </button>
  </div>

  {showAllProjects && (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 max-w-6xl mx-auto mt-8">
      {projectData
        .filter((p) => !['AI-Based Structural Health Monitoring System', 'Internal Logistics Autonomous Robot', '2D Contour Detection & 3D Depth Mapping System', 'Autonomous GPS-Based Delivery Robot', 'Four-Axis Robotic Arm with Precision Control', 'Emergency Communication & Alert System'].includes(p.title))
        .map((project, index) => (
          <motion.div
...
<section id="certifications" className="py-16 px-4 bg-white dark:bg-gray-900">
  <div className="max-w-6xl mx-auto">
    ...
    <div className="grid md:grid-cols-2 gap-8">
      {certificationData.filter(cert => ['Embedded Software and Hardware Architecture', 'Linux Embedded System Topics and Projects', 'Networking and Storage Essentials', 'System Design Through Verilog'].includes(cert.title)).map((cert, index) => (
        <motion.div
          key={index}
    ...
    {/* Toggle for All Certifications */}
    <div className="text-center mt-8">
      <button
        onClick={() => setShowAllCerts(!showAllCerts)}
        className="px-6 py-2 bg-cyan-400 text-black font-semibold rounded-full hover:bg-pink-500 hover:text-white transition duration-300"
      >
        {showAllCerts ? 'Hide' : 'View All Certifications'}
      </button>
    </div>
...
<section id="skills" className="py-20 bg-gradient-to-b from-black via-gray-900 to-black px-6">
  ...
  <div className="space-y-8 max-w-4xl mx-auto text-center">
    <div>
      <h3 className="text-2xl font-semibold text-cyan-400 mb-4">Primary Skills</h3>
      <p className="text-gray-300">Embedded C, Python, Linux, STM32, ESP32, Raspberry Pi, OpenCV</p>
    </div>
    <div>
      <h3 className="text-2xl font-semibold text-cyan-400 mb-4">Secondary Skills</h3>
      <p className="text-gray-300">Arduino, PLCs (Siemens, Mitsubishi), MATLAB, Verilog, SQL, Git</p>
    </div>
    <div>
      <h3 className="text-2xl font-semibold text-cyan-400 mb-4">Tools</h3>
      <p className="text-gray-300">STM32CubeIDE, Arduino IDE, KiCad, Quartus, Multisim, Fusion 360</p>
    </div>
  </div>
</section>
